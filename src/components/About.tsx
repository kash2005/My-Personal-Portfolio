    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-6" id="about">
      ...
      <div className="flex flex-col items-center lg:items-start lg:justify-start">
        ...
        <li className="icon-content group">
          <a href="https://www.linkedin.com/in/kashmi-fernando-31976427b" aria-label="LinkedIn" className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 group-hover:bg-blue-700">
        ...
        <li className="icon-content group">
          <a href="https://github.com/kash2005" aria-label="GitHub" className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 group-hover:bg-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-[#001845] group-hover:text-white" viewBox="0 0 16 16">
      ...
      <li className="group">
        <a href="https://web.facebook.com/kashmi%20fernando?_rdc=1&_rdr" aria-label="Facebook" className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 group-hover:bg-blue-600">
      ...
      <li className="icon-content group">
        <a href="https://www.instagram.com/kash_fernando" aria-label="Instagram" className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 group-hover:bg-gradient-to-tr group-hover:from-purple-400 group-hover:to-pink-500">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-[#001845] group-hover:text-white" viewBox="0 0 16 16">
